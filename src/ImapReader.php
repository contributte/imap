...
final class ImapReader
{
	 ...
	 * Set message flag
	 *
	 * @param string|array<string> $sequence Message numbers
	 * @param string|array<string> $flag Message flag
	 */
	...
	protected function connect(): void
	{
		...
		if ($connection === false) {
			throw new RuntimeException('Failed to connect to IMAP mailbox');
		}
	...
	public function __call(string $name, array $arguments): mixed
	{
		...
		return call_user_func_array('imap_' . $name, $args); // @phpstan-ignore argument.type
	}
